...
const COMPONENTS = [
  {
    label: "Caja Control (T3–T8)",
    pct: 59,
    detail: "2,464 / 6,000 hr",
    color: "warn" as const,
  },
  {
    label: "Blindajes Turbina",
    pct: 85,
    detail: "est. vida restante",
    color: "good" as const,
  },
  {
    label: "Filtros Colector",
    pct: 66,
    detail: "2,011 / 6,000 hr",
    color: "warn" as const,
  },
  {
    label: "Blindajes Puntos Calientes",
    pct: 85,
    detail: "est. vida restante",
    color: "good" as const,
  },
      ...
      <header className="sticky top-0 z-50 border-b-[3px] border-[#1a5fa8] bg-white shadow-[0_2px_12px_rgba(26,95,168,0.08)]">
        <div className="mx-auto grid max-w-[1200px] grid-cols-[auto_1fr_auto] items-stretch">
          ...
          <div className="flex items-center gap-3 border-r border-[#dde3ec] px-6 py-3.5">
            <Link
              href="/home"
              className="font-[family-name:var(--font-barlow-condensed)] text-[17px] font-black tracking-wider text-[#0f2137]"
            >
          ...
          <div className="flex flex-col justify-center px-6 py-3.5">
            ...
            <div className="text-[11px] tracking-wide text-[#8494aa] uppercase">
              PEGASUS AUTOPARTS · No. In-Plant: 052-141-08 · Ing. Miguel Rios ·
              miguel.rios@dooble-inox.de
            </div>
          </div>
          {/* Report info */}
          <div className="flex flex-col items-end justify-center gap-0 border-l border-[#dde3ec] px-6 py-3.5">
            <div className="font-[family-name:var(--font-jetbrains)] text-[11px] font-semibold tracking-wide text-[#1a5fa8]">
              # 052-141-08-1459
            </div>
            ...
            <div className="mt-2 flex items-stretch gap-2.5">
              ...
              <div className="text-right">
                ...
                <div className="font-[family-name:var(--font-jetbrains)] text-xl leading-tight font-bold text-[#1a5fa8]">
                  2,464
                </div>
              ...
              <div className="text-right">
                ...
                <div className="font-[family-name:var(--font-jetbrains)] text-sm leading-tight font-semibold text-[#3d4f63]">
                  2,315 hr
                </div>
              ...
              <div className="text-right">
                ...
                <div className="font-[family-name:var(--font-jetbrains)] text-lg leading-tight font-bold text-[#1a9e5c]">
                  +149
                </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-[1fr_1fr_2fr]">
            ...
            <div className="relative overflow-hidden rounded border border-[#dde3ec] bg-[#f9fafb] p-5">
              ...
              <div className="mt-2 font-[family-name:var(--font-barlow-condensed)] text-xl font-bold text-[#1a9e5c]">
                Buenas Condiciones
              </div>
              <div className="mt-2 flex items-center gap-1.5 text-[11px] text-[#8494aa]">
                Horómetro{" "}
                <span className="font-[family-name:var(--font-jetbrains)] text-[#3d4f63]">
                  2,464 hr
                </span>
              </div>
            </div>
            ...
            <div className="rounded border border-[#dde3ec] bg-[#f9fafb] p-5">
              ...
              <ul className="flex flex-col gap-2">
                {RECOMMENDATIONS.map((rec, i) => (
                  ...
                  >
                    <span className="font-[family-name:var(--font-jetbrains)] text-[10px] text-[#1a5fa8]">
          ...
          <div className="rounded border border-[#dde3ec] bg-[#f9fafb] p-5">
            ...
            <div className="mb-3.5 grid grid-cols-[90px_repeat(8,1fr)] items-center gap-1.5">
              ...
              {TURBINES.map((t) => (
                ...
                >
                  <div className="mb-1.5 font-[family-name:var(--font-barlow-condensed)] text-[15px] font-bold text-[#0f2137]">
                    {t.name}
                  </div>
                  ...
                  <div
                    className={`mt-1 font-[family-name:var(--font-jetbrains)] text-[13px] font-semibold ${statusTextColor(t.status)}`}
                  >
                    {t.pct}%
                  </div>
                  <div className="mt-0.5 text-[11px] font-medium text-[#3d4f63]">
                    {t.hours.toLocaleString()} hr
                  </div>
                </div>
              ))}
            </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <div className="h-1.5 flex-1 overflow-hidden rounded-full bg-[#b0bacb]">
                      <div
                        className={`h-full rounded-full ${statusColor(c.color)}`}
                        style={{ width: `${c.pct}%` }}
                      />
                    </div>
                    <span
                      className={`font-[family-name:var(--font-jetbrains)] text-[13px] font-semibold ${statusTextColor(c.color)}`}
                    >
                      {c.pct}%
                    </span>
                  </div>
        ...
        <div>
          ...
          <div className="rounded border border-[#dde3ec] bg-[#f9fafb] p-5">
            <div className="mb-4 flex items-start justify-between">
              <div>
                <div className="font-[family-name:var(--font-barlow-condensed)] text-base font-bold text-[#0f2137]">
                  Consumo de Granalla por Hora Efectiva
                </div>
                <div className="mt-0.5 text-[11px] text-[#8494aa]">
                  Últimas 12 visitas — valor tomado al momento de la visita
                </div>
              </div>
              <div className="text-right">
                <div className="font-[family-name:var(--font-jetbrains)] text-[22px] font-bold text-[#1a5fa8]">
                  2.53
                </div>
            ...
            >
              ...
              {/* Area */}
              <path
                d="M 75,115 L 150,80 L 225,93 L 300,71 L 375,112 L 450,95 L 525,68 L 600,100 L 675,90 L 750,75 L 825,105 L 825,140 L 75,140 Z"
                fill="url(#lineGrad)"
              />
              {/* Line */}
              <polyline
                points="75,115 150,80 225,93 300,71 375,112 450,95 525,68 600,100 675,90 750,75 825,105"
                fill="none"
                stroke="#1a5fa8"
                strokeWidth="2"
            ...
            <div className="rounded border border-[#dde3ec] bg-[#f9fafb] p-5">
              ...
              {GRAN_DATA.map((g) => {
                ...
                return (
                  ...
                  >
                    <span className="font-[family-name:var(--font-jetbrains)] text-xs font-semibold text-[#1a3a5c]">
                      {g.malla}
                    </span>
                    ...
                    <span className="text-right font-[family-name:var(--font-jetbrains)] text-xs font-semibold text-[#5a6e82]">
                      {(g.ideal * 100).toFixed(0)}%
                    </span>
                    <span className="text-right font-[family-name:var(--font-jetbrains)] text-xs font-semibold text-[#1a3a5c]">
                      {(g.real * 100).toFixed(0)}%
                    </span>
                    <span
                      className={`text-right font-[family-name:var(--font-jetbrains)] text-xs font-semibold ${diffClass}`}
                    >
                      {diffSign}
                      {(diff * 100).toFixed(1)}%
                    </span>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-3.5 rounded border border-[#dde3ec] bg-[#f9fafb] p-5">
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-baseline gap-1.5">
                    <span className="font-[family-name:var(--font-jetbrains)] text-xl text-[#d4860a]">
                      91%
                    </span>
                    <span className="text-[11px] text-[#8494aa]">
                      real vs <span className="text-[#3d4f63]">ideal</span>
                    </span>
                  </div>
                ...
                <div>
                  ...
                  <div className="mt-1 font-[family-name:var(--font-jetbrains)] text-sm text-[#3d4f63]">
                    4.10 g/cm³
                  </div>
                </div>
              </div>
              ...
              <div className="rounded border border-[#dde3ec] bg-white p-4">
                <div className="mb-2 text-[10px] tracking-widest text-[#8494aa] uppercase">
                  Granalla Instalada
                  <span className="ml-1.5 font-[family-name:var(--font-jetbrains)] text-[9px] text-[#b0bacb]">
                    2003-09-05
                  </span>
                </div>
                ...
                <div className="mt-2.5 rounded border border-[rgba(212,134,10,0.18)] bg-[rgba(212,134,10,0.07)] px-2.5 py-2">
                  ...
                  <div className="mt-1 text-[11px] leading-relaxed text-[#3d4f63]">
                    MIX OPERATIVO CON EXCESO DE GRANO NUEVO
                  </div>
                </div>
              </div>
            </div>
